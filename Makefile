build:
	...
	opm index add --generate -b quay.io/agreene/bundle-example:$(TAG)
...
install-crds:
	kubectl apply -f bundle/manifests/servicemonitor.crd.yaml
	kubectl apply -f bundle/manifests/prometheusrule.crd.yaml
